    ...
    <body>
        ...
        if ($spelstop) {
            ...
            <table>
                <tr>
                    <td>
                        <form action="lucifers.php?aantal=1" method="post">
                            <input type="submit" value="Eén lucifer wegnemen" />
                        </form>
                    </td>
                    <td>
                        <form action="lucifers.php?aantal=2" method="post">
        ...
        <br />
        <p>
            Klik <a href="lucifers.php?reset=1">hier</a> om een nieuw spel te beginnen.
        </p>
    </body>
</html>
