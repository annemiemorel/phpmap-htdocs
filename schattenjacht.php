...
<html>
    ...
    <body>
        ...
        for ($i = 1; $i <= 7; $i++) {
            ?>
            <a href="schattenjacht.php?kiesdeur=<?php print($i);?>" 
                <?php if(isset($msg)) {print('class="inactief"');} ?> > <!-- EXTRA -->
                <?php
                if ($_SESSION["deurenReeks"][$i] == 0) {
                    ?>
                <img src="images/doorclosed.png" alt="gesloten deur"/>
                    <?php
                } elseif ($_SESSION["deurenReeks"][$i] == 1) {
                    ?>
                <img src="images/dooropen.png" alt="open deur" />
                    <?php
                } elseif ($_SESSION["deurenReeks"][$i] == 2) {
                    ?>
                <img src="images/doortreasure.png" alt="deur met schat" />
                    <?php
                }
                ?>
            </a>
        ...
        <p>
            Klik <a href="schattenjacht.php?reset=1">hier</a> om een nieuw spel te beginnen.
        </p>
    </body>
</html>
