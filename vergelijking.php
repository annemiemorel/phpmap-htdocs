...
<html> 
    ...
    <body> 
        <h1> <?php $vgl = new Vergelijking(); print($vgl->getSomIsStriktPositief(10, -9)); ?> </h1> 
        <h1> <?php $vgl = new Vergelijking(); print($vgl->getSomIsStriktNegatief(30, -9, -12)); ?> </h1> 
    </body> 
</html>